...
namespace vise {
  const char *VISE_HTML_HEAD = R"HTML_STR(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  const char *PROJECT_HTML_HEAD = R"HTML_STR(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate" />
  ...
  const char *HTML_SVG_ASSETS = R"SVG(<svg style="display:none;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<!--
...
<defs>
  ...
  const char *HTML_TAIL = R"TEXT(
</body>
</html>)TEXT";
  const char *HTML_EMPTY_TAIL = R"TEXT(
</body>
</html>)TEXT";
}
#endif
